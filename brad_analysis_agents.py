...
embeddings = VoyageAIEmbeddings(voyage_api_key=os.environ.get("VOYAGE_API_KEY"), model="voyage-large-2")
...
class BradAnalysisAgents():
  ...
  def webpage_scraper(self):
    return Agent(
      role="Webpage Scraper",
      goal="""To extract specific information from webpages and provide structured data that can be used for further analysis. This task requires the ability to navigate web content, identify relevant data points, and present them in a clear and organized format.
      
      Important:
                - Once you've found the information, immediately stop scraping for additional information.
                - Only return the requested information. NOTHING ELSE!
                - Do not generate fake information. Only return the information you find. Nothing else!
                - Do not stop scraping until you find the requested information.
                
                """,
      backstory="""As a Webpage Scraper, your role is to extract valuable data from webpages with precision and efficiency. Your expertise in web scraping tools and techniques enables you to navigate through complex web content, identify key data points, and structure the information for further analysis. Your work is essential in gathering real-time data from online sources, providing insights that drive strategic decision-making and market analysis.""",
      verbose=True,
      llm=self.llm,
      function_calling_llm=self.llm,
      max_rpm=16,
