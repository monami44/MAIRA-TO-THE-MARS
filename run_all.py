...
if __name__ == "__main__":
    ...
    batch1 = scripts[0:3]   # Scripts 1-5
    batch2 = scripts[3:6]  # Scripts 6-10
    batch3 = scripts[6:9] # Scripts 11-15
    batch4 = scripts[9:12]   # Scripts 16-21
    batch5 = scripts[12:15]
    batch6 = scripts[15:18]
    batch7 = scripts[18:21]   # Scripts 16-21

    # Execute the scripts in batches
    execute_scripts_in_batches([batch1, batch2, batch3, batch4,batch5,batch6,batch7], company)

    # Directory paths for checking file presence
    directory_path = "/Users/emiliosanalv/Downloads/brad_Financeteam 2/output"
    sup_main_py_directory = "/Users/emiliosanalv/Downloads/brad_Financeteam 2"
